...
This is a simple photobooth web app where users can:

📷 Access the camera and take photos directly in their browser
...
It’s built with HTML, CSS, and JavaScript, and deployed on Vercel for easy sharing and access.
...
The camera is accessed with browser APIs.

A live video preview shows what the photo will look like.

Pressing Take Photo captures the frame.

The result is shown on a canvas with custom UI elements.
...
📍 HTML / CSS (styled with a pixel‑style font for fun)

🖥️ JavaScript (for camera & canvas handling)
...
Run npm install (if using any build tools)

Start a dev server

Open localhost in a real browser (Chrome/Safari)
